...
class Product{
    ...
    public function insertProduct( $brand_id, $product_name, $product_price, $product_color,$product_detail, $product_maintain, $product_consult, $newImageName){
        $query="INSERT INTO tbl_product(brand_id,product_name,product_price,product_color,product_detail,product_maintain,product_consult,product_img) 
                VALUES ('$brand_id','$product_name','$product_price','$product_color','$product_detail','$product_maintain','$product_consult','$newImageName')";
